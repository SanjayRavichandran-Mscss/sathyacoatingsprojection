          ...
          <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
            ...
            {/* {activeOverheadTab === "material" && (
              <div>
               ...
               <MaterialPlanning selectedCompany={selectedCompany} selectedProject={selectedProject} selectedSite={selectedSite} selectedWorkDesc={selectedWorkDescription}  onTotalCostChange={handleTotalCostChange} onMaterialsChange={handleMaterialsChange}/>
