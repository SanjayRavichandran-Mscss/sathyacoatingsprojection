...
const POMasterCreation = ({
  ...
  useEffect(() => {
    const fetchDropdownData = async () => {
      try {
        ...
        const inchargeResponse = await axios.get("https://scpl.kggeniuslabs.com/api/reckoner/incharge-types");
        setInchargeTypes(
        ...
        const locationResponse = await axios.get("https://scpl.kggeniuslabs.com/api/reckoner/locations");
        setLocations(
        ...
        const reckonerTypeResponse = await axios.get("https://scpl.kggeniuslabs.com/api/reckoner/reckoner-types");
        setReckonerTypes(
      ...
      const fetchSites = async () => {
        try {
          ...
          const response = await axios.get(
            `https://scpl.kggeniuslabs.com/api/reckoner/sites-by-company/${selectedCompanyId}`
          );
          ...
          const siteReckonerPromises = sitesData.map(async (site) => {
            try {
              const reckonerResponse = await axios.get(
                `https://scpl.kggeniuslabs.com/api/reckoner/site-reckoner/${site.site_id}`
              );
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const categoriesRes = await axios.get("https://scpl.kggeniuslabs.com/api/reckoner/categories");
        setCategories(categoriesRes.data.data || []);

        setLoading((prev) => ({ ...prev, subcategories: true }));
        const subcategoriesRes = await axios.get("https://scpl.kggeniuslabs.com/api/reckoner/subcategories");
        setSubcategories(subcategoriesRes.data.data || []);

        setLoading((prev) => ({ ...prev, workItems: true }));
        const workItemsRes = await axios.get("https://scpl.kggeniuslabs.com/api/reckoner/work-items");
  ...
  const handleUpdateSite = async (siteId) => {
    try {
      ...
      await axios.put(`https://scpl.kggeniuslabs.com/api/reckoner/sites/${siteId}`, updateData);
  ...
  const handleCreateCategory = async (categoryName) => {
    try {
      const response = await axios.post("https://scpl.kggeniuslabs.com/api/reckoner/categories", {
  ...
  const handleCreateWorkItem = async (descName) => {
    try {
      const response = await axios.post("https://scpl.kggeniuslabs.com/api/reckoner/work-items", {
        desc_name: descName,
      });
  ...
  const handleCreateSubcategory = async (categoryIndex, itemIndex) => {
    ...
    try {
      const response = await axios.post("https://scpl.kggeniuslabs.com/api/reckoner/subcategories", {
  ...
  const processSite = async (poNumber) => {
    try {
      ...
      await axios.get(`https://scpl.kggeniuslabs.com/api/sheet/process/${encodeURIComponent(poNumber)}`);
      return true;
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post("https://scpl.kggeniuslabs.com/api/reckoner/reckoner", submissionData);
