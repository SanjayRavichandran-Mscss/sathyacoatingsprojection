...
const AdditionalCash = () => {
    ...
    if (formData.site_id) {
      const fetchWorkDescriptions = async () => {
        try {
          ...
          const response = await axios.get(`https://scpl.kggeniuslabs.com/api/expense/work-descriptions/${formData.site_id}`);
  ...
  useEffect(() => {
    const fetchPettyCash = async () => {
      try {
        ...
        const response = await axios.get("https://scpl.kggeniuslabs.com/api/expense/fetch-petty-cash");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post(
        "https://scpl.kggeniuslabs.com/api/expense/add-petty-cash",
