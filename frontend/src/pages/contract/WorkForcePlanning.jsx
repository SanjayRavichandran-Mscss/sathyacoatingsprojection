    ...
    const fetchCompaniesAndProjects = async () => {
      ...
      try {
        const [companyResponse, projectResponse] = await Promise.all([
          axios.get("https://scpl.kggeniuslabs.com/api/project/companies"),
          axios.get("https://scpl.kggeniuslabs.com/api/project/projects-with-sites"),
        ]);
    ...
    const fetchEmployees = async () => {
      ...
      try {
        const [empResponse, labourResponse] = await Promise.all([
          axios.get("https://scpl.kggeniuslabs.com/api/site-incharge/employees"),
          axios.get("https://scpl.kggeniuslabs.com/api/admin/labour"),
        ]);
        if (isMounted) {
  ...
  useEffect(() => {
    if (selectedProject && selectedSite) {
      ...
      const fetchWorkDescriptions = async () => {
        setLoading(true);
        try {
          const response = await axios.get(`https://scpl.kggeniuslabs.com/api/site-incharge/work-descriptions?site_id=${selectedSite.value}`);
  ...
  const handleSaveAssignments = async () => {
    ...
    try {
        if (hasIncharge) {
            ...
            await axios.post("https://scpl.kggeniuslabs.com/api/material/assign-incharge", inchargePayload);
        ...
        if (hasLabour) {
            ...
            await axios.post("https://scpl.kggeniuslabs.com/api/site-incharge/save-labour-assignment", labourPayload);
