...
const MaterialPlanning = () => {
  ...
  const fetchAssignedMaterials = async (site_id, desc_id) => {
    try {
      ...
      const response = await axios.get(`http://103.118.158.33/api/material/assigned-materials?site_id=${site_id}&desc_id=${desc_id}`);
  ...
  const fetchSplittedBudget = async (site_id, desc_id) => {
    try {
      ...
      const response = await axios.get(`http://103.118.158.33/api/admin/fetch-material-planning-budget?site_id=${site_id}&desc_id=${desc_id}`);
