...
//       const res = await axios.get("http://103.118.158.33/api/project/companies");
...
//       const res = await axios.get("http://103.118.158.33/api/project/projects-with-sites");
//       if (Array.isArray(res.data) && res.data.length > 0) {
...
const WorkCompletionEntry = () => {
  ...
  const handleUpdateEntry = async (entryId, recId) => {
    try {
      ...
      await axios.put(
        "http://103.118.158.33/api/site-incharge/update-completion-entry",
        payload
      );
