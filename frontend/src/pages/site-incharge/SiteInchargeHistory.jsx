      ...
      const fetchData = async () => {
        try {
          ...
          const [
            ...
            axios.get(`http://103.118.158.127/api/site-incharge/acknowledgements-by-incharge/${userId}`),
            axios.get(`http://103.118.158.127/api/site-incharge/material-usage-by-incharge/${userId}`),
            axios.get(`http://103.118.158.127/api/site-incharge/expense-by-incharge/${userId}`),
            axios.get(`http://103.118.158.127/api/site-incharge/completion-by-incharge/${userId}`),
            axios.get(`http://103.118.158.127/api/site-incharge/labour-assignment-by-incharge/${userId}`),
            axios.get(`http://103.118.158.127/api/site-incharge/labour-attendance-by-incharge/${userId}`)
          ]);
