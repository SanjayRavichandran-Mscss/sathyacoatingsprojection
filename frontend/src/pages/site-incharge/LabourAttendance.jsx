...
const LabourAttendance = () => {
      ...
      const fetchLabourAttendance = async () => {
        ...
        try {
          const response = await axios.get(
            `http://103.118.158.33/api/site-incharge/labour-attendance?project_id=${selectedProject.value}&site_id=${selectedSite.value}&desc_id=${selectedWorkDesc.value}&entry_date=${selectedDate}`
          );
  ...
  const handleSaveRow = async (labour) => {
    ...
    try {
      ...
      const response = await axios.post("http://103.118.158.33/api/site-incharge/save-labour-attendance", payload);
