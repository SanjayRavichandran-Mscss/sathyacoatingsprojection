...
const MaterialAcknowledgement = () => {
  ...
  const handleAcknowledge = async (dispatchId) => {
    ...
    try {
      ...
      const response = await axios.post("https://scpl.kggeniuslabs.com/api/site-incharge/acknowledge-material", {
      ...
      const responseRefresh = await axios.get(
        `https://scpl.kggeniuslabs.com/api/site-incharge/acknowledgement-details?material_dispatch_id=${dispatchId}`
      );
  ...
  const handleUpdateAcknowledge = async (dispatchId, ackId) => {
    ...
    try {
      ...
      const response = await axios.put("https://scpl.kggeniuslabs.com/api/site-incharge/update-acknowledgement", {
