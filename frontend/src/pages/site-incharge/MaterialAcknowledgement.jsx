...
const MaterialAcknowledgement = () => {
  ...
  const handleAcknowledge = async (dispatchId) => {
    ...
    try {
      ...
      const response = await axios.post("http://103.118.158.33/api/site-incharge/acknowledge-material", {
      ...
      const responseRefresh = await axios.get(
        `http://103.118.158.33/api/site-incharge/acknowledgement-details?material_dispatch_id=${dispatchId}`
      );
  ...
  const handleUpdateAcknowledge = async (dispatchId, ackId) => {
    ...
    try {
      ...
      const response = await axios.put("http://103.118.158.33/api/site-incharge/update-acknowledgement", {
