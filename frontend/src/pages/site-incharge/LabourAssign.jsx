...
const LabourAssign = () => {
  ...
  useEffect(() => {
    if (selectedProject && selectedSite) {
      ...
      const fetchWorkDescriptions = async () => {
        ...
        try {
          const response = await axios.get(
            `https://scpl.kggeniuslabs.com/api/site-incharge/work-descriptions?site_id=${selectedSite.value}`
          );
          if (isMounted) {
      ...
      const fetchLabours = async () => {
        setLoading(true);
        try {
          const response = await axios.get("https://scpl.kggeniuslabs.com/api/site-incharge/labours");
  ...
  const handleSaveAssignment = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://scpl.kggeniuslabs.com/api/site-incharge/save-labour-assignment",
        payload
      );
  ...
  const handleViewAssignedLabours = async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.get(
        `https://scpl.kggeniuslabs.com/api/site-incharge/assigned-labours?project_id=${selectedProject.value}&site_id=${selectedSite.value}&desc_id=${selectedWorkDesc.value}`
      );
  ...
  const handleUpdateAssignment = async (assignmentId) => {
    ...
    try {
      ...
      const response = await axios.put(
        "https://scpl.kggeniuslabs.com/api/site-incharge/update-labour-assignment",
        payload
      );
      toast.success(response.data.message);
