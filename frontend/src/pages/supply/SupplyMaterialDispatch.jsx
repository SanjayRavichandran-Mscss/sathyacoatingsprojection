...
const SupplyMaterialDispatch = () => {
  ...
  const saveMasterDcNo = async () => {
    ...
    try {
      await axios.post("https://scpl.kggeniuslabs.com/api/supply/master-dc-no", {
  ...
  const fetchAssignedMaterials = async () => {
    ...
    setError(null);
    try {
      const response = await axios.get(`https://scpl.kggeniuslabs.com/api/supply/assigned-materials/?site_id=${selectedSite}`);
  ...
  const fetchTransportTypes = async () => {
    ...
    try {
      const response = await axios.get("https://scpl.kggeniuslabs.com/api/supply/supply-transport-types");
  ...
  const fetchProviders = async (transport_type_id) => {
    ...
    try {
      const response = await axios.get("https://scpl.kggeniuslabs.com/api/supply/supply-providers", {
  ...
  const fetchVehicles = async () => {
    ...
    try {
      const response = await axios.get("https://scpl.kggeniuslabs.com/api/supply/supply-vehicles");
  ...
  const fetchDrivers = async () => {
    ...
    try {
      const response = await axios.get("https://scpl.kggeniuslabs.com/api/supply/supply-drivers");
  ...
  const handleDispatchSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post("https://scpl.kggeniuslabs.com/api/supply/add-supply-dispatch", payload);
