...
const SupplyMaterialDispatch = () => {
  ...
  const fetchCompanies = async () => {
    ...
    try {
      const response = await axios.get("http://103.118.158.33/api/supply/companies");
      setCompanies(
  ...
  const fetchSitesByCompany = async () => {
    ...
    try {
      const response = await axios.get(`http://103.118.158.33/api/supply/sites-by-company/${selectedCompany}`);
  ...
  const fetchMasterDcNo = async () => {
    ...
    try {
      const response = await axios.get("http://103.118.158.33/api/supply/master-dc-no", {
  ...
  const saveMasterDcNo = async () => {
    ...
    try {
      await axios.post("http://103.118.158.33/api/supply/master-dc-no", {
  ...
  const fetchNextDcNo = async () => {
    ...
    try {
      const response = await axios.get("http://103.118.158.33/api/supply/next-supply-dc-no", {
  ...
  const fetchAssignedMaterials = async () => {
    ...
    setError(null);
    try {
      const response = await axios.get(`http://103.118.158.33/api/supply/assigned-materials/?site_id=${selectedSite}`);
  ...
  const fetchTransportTypes = async () => {
    ...
    try {
      const response = await axios.get("http://103.118.158.33/api/supply/supply-transport-types");
  ...
  const fetchProviders = async (transport_type_id) => {
    ...
    try {
      const response = await axios.get("http://103.118.158.33/api/supply/supply-providers", {
  ...
  const fetchVehicles = async () => {
    ...
    try {
      const response = await axios.get("http://103.118.158.33/api/supply/supply-vehicles");
  ...
  const fetchDrivers = async () => {
    ...
    try {
      const response = await axios.get("http://103.118.158.33/api/supply/supply-drivers");
  ...
  const handleDispatchSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post("http://103.118.158.33/api/supply/add-supply-dispatch", payload);
