    ...
    const fetchData = async () => {
      try {
        ...
        const [completionResponse, poTotalsResponse, expenseResponse, labourResponse, materialResponse] = await Promise.all([
          ...
          axios.get(`http://103.118.158.33/api/site-incharge/calculate-labour-budget`),
          axios.get(`http://103.118.158.33/api/admin/material-graph/${selectedSite.value}/${selectedDescription.value}`) // Add this line
        ]);
