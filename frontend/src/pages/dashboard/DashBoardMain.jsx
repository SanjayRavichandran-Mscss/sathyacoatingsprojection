    ...
    const fetchData = async () => {
      try {
        ...
        const [completionResponse, poTotalsResponse, expenseResponse, labourResponse, materialResponse] = await Promise.all([
          ...
          axios.get(`https://scpl.kggeniuslabs.com/api/admin/expense-details/${selectedSite.value}/${selectedDescription.value}`),
          axios.get(`https://scpl.kggeniuslabs.com/api/site-incharge/calculate-labour-budget`),
          axios.get(`https://scpl.kggeniuslabs.com/api/admin/material-graph/${selectedSite.value}/${selectedDescription.value}`) // Add this line
        ]);
