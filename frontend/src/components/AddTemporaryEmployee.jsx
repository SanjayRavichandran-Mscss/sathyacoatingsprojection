    ...
    if (isOpen && saveToDatabase) {
      (async () => {
        try {
          ...
          const { data } = await axios.get("https://scpl.kggeniuslabs.com/api/material/genders");
        ...
        try {
          ...
          const { data } = await axios.get("https://scpl.kggeniuslabs.com/api/material/departments");
        ...
        try {
          ...
          const { data } = await axios.get("https://scpl.kggeniuslabs.com/api/material/employment-types");
        ...
        try {
          ...
          const { data } = await axios.get("https://scpl.kggeniuslabs.com/api/material/designations");
        ...
        try {
          ...
          const { data } = await axios.get("https://scpl.kggeniuslabs.com/api/material/statuses");
        ...
        try {
          ...
          const { data } = await axios.get("https://scpl.kggeniuslabs.com/api/admin/contractors");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (saveToDatabase) {
        ...
        const response = await axios.post("https://scpl.kggeniuslabs.com/api/admin/add-labour", labourData);
