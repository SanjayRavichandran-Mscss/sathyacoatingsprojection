...
const ProjectCreation = ({ companyId, onClose, onProjectCreated }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const [
        ...
        axios.get(`https://scpl.kggeniuslabs.com/api/project/companies/${companyId}`),
        axios.get("https://scpl.kggeniuslabs.com/api/project/site-incharges"),
        axios.get(`https://scpl.kggeniuslabs.com/api/project/projects/${companyId}`),
        axios.get(`https://scpl.kggeniuslabs.com/api/project/locations`),
        axios.get(`https://scpl.kggeniuslabs.com/api/project/reckoner-types`),
        axios.get("https://scpl.kggeniuslabs.com/api/material/employees"),
      ]);
        ...
        if (!isCustomPoNumber) {
          try {
            const response = await axios.get(
              `https://scpl.kggeniuslabs.com/api/project/next-po-number/${formData.reckoner_type_id}`
            );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Submit data
      const response = await axios.post("https://scpl.kggeniuslabs.com/api/project/create-project-site", projectData);
