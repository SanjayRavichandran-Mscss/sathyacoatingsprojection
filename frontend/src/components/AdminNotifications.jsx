    ...
    const fetchInitialData = async () => {
      ...
      try {
        ...
        const [countsRes, acksRes] = await Promise.all([
          axios.get('https://scpl.kggeniuslabs.com/api/notification/counts', {
            headers: { Authorization: `Bearer ${token}` }
          }),
          axios.get('https://scpl.kggeniuslabs.com/api/notification/pending-acknowledgements', {
            headers: { Authorization: `Bearer ${token}` }
          })
        ]);
  ...
  const fetchTabData = async (tab) => {
    ...
    try {
      ...
      if (tab === 'acknowledgements') {
        if (isEdited) {
          res = await axios.get('https://scpl.kggeniuslabs.com/api/notification/edited-acknowledgements', {
            headers: { Authorization: `Bearer ${token}` }
          });
          ...
          res = await axios.get('https://scpl.kggeniuslabs.com/api/notification/pending-acknowledgements', {
            headers: { Authorization: `Bearer ${token}` }
          });
          if (res.data.status === 'success') {
            const data = res.data.data;
        ...
        if (isEdited) {
          res = await axios.get('https://scpl.kggeniuslabs.com/api/notification/edited-usages', {
            headers: { Authorization: `Bearer ${token}` }
          });
          if (res.data.status === 'success') {
            const data = res.data.data;
          ...
          res = await axios.get('https://scpl.kggeniuslabs.com/api/notification/pending-usages', {
            headers: { Authorization: `Bearer ${token}` }
          });
          if (res.data.status === 'success') {
            const data = res.data.data;
        ...
        if (isEdited) {
          res = await axios.get('https://scpl.kggeniuslabs.com/api/notification/edited-expenses', {
            headers: { Authorization: `Bearer ${token}` }
          });
          if (res.data.status === 'success') {
            const data = res.data.data;
          ...
          res = await axios.get('https://scpl.kggeniuslabs.com/api/notification/pending-expense-entries', {
            headers: { Authorization: `Bearer ${token}` }
          });
          if (res.data.status === 'success') {
            const data = res.data.data;
        ...
        if (isEdited) {
          res = await axios.get('https://scpl.kggeniuslabs.com/api/notification/edited-completion-entries', {
            headers: { Authorization: `Bearer ${token}` }
          });
          if (res.data.status === 'success') {
            const data = res.data.data;
          ...
          res = await axios.get('https://scpl.kggeniuslabs.com/api/notification/pending-completion-entries', {
            headers: { Authorization: `Bearer ${token}` }
          });
          if (res.data.status === 'success') {
            const data = res.data.data;
        ...
        if (isEdited) {
          res = await axios.get('https://scpl.kggeniuslabs.com/api/notification/edited-attendance-entries', {
            headers: { Authorization: `Bearer ${token}` }
          });
          if (res.data.status === 'success') {
            const data = res.data.data;
          ...
          res = await axios.get('https://scpl.kggeniuslabs.com/api/notification/pending-attendance-entries', {
            headers: { Authorization: `Bearer ${token}` }
          });
          if (res.data.status === 'success') {
            const data = res.data.data;
